<template>
  <div class="login-wrap">
    <el-form label-position="left"  ref="ruleForm" label-width="0px" class="demo-ruleForm login-container" style="background-color: transparent;border:none;">
      <h3 class="title" >用户登录</h3>
      <el-form-item prop="user">
        <el-input type="text" v-model="user" auto-complete="off" placeholder="账号"></el-input>
      </el-form-item>
      <el-form-item prop="pass">
        <el-input type="password" v-model="pass" auto-complete="off" placeholder="密码" ></el-input>
      </el-form-item>
      <el-checkbox class="remember" v-model="rememberpwd">记住密码</el-checkbox>
      <el-form-item style="width:100%;">
        <el-button type="primary" style="width:100%;" @click="submitForm">登录</el-button>
        <el-button type="danger" style="width:100%;margin-left: 0px" @click="reset">重置</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
